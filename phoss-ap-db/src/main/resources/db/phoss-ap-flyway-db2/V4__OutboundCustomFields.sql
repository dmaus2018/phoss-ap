...
-- Custom outbound transaction fields (issue #64)
-- Three optional custom identifier fields, max 255 characters each.
-- Existing rows default to NULL. Mirrored into the archive table.
