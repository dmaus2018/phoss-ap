...
final class APDBExecutor extends DBExecutor
{
  ...
  /**
   * Set the global DataSource provider to be used. This method may only be called once.
   *
   * @param aDSP
  ...
  /**
   * @return a {@link Supplier} that creates new DB executor instances. Never <code>null</code>.
   */
  @NonNull
