 ...
 */
public enum EAttemptStatus implements IHasID <String>
{
  ...
  EAttemptStatus (@NonNull @Nonempty final String sID)
  {
    m_sID = sID;
  }
   ...
   */
  @Nullable
  public static EAttemptStatus getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EAttemptStatus.class, sID);
  }
}
